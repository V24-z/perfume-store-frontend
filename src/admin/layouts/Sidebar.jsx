    ...
    >
      ...
      >
        <div className="flex items-center gap-2.5">
          ...
          >
            <i className="ti ti-droplet" style={{ fontSize: 17, color: "#fde047" }} aria-hidden="true" />
          </div>
          <div>
            <p className="m-0 font-bold text-white tracking-widest text-sm">LUMIÈRE</p>
            <p className="m-0 text-[9px] tracking-[0.15em]" style={{ color: "rgba(250,204,21,0.5)" }}>
              ADMIN
            </p>
          </div>
        </div>
        ...
        {navSections.map((section) => (
          <div key={section.label}>
            ...
            {section.items.map(({ to, icon, label, badge, badgeType }) => (
              ...
              >
                <i className={`ti ${icon}`} style={{ fontSize: 18, flexShrink: 0 }} aria-hidden="true" />
