...
const Header = ({ onToggleSidebar }) => {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between px-3 md:px-5 py-3" style={{ borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
        {/* Left */}
        ...
        {/* Right */}
        <div className="flex items-center gap-1.5 md:gap-2 relative"> {/* Added relative for dropdown */}
          ...
          {isDropdownOpen && (
            <div 
              className="absolute right-0 top-full mt-2 w-32 rounded-lg shadow-xl z-50 p-1"
              style={{ background: "#1a0533", border: "1px solid rgba(255,255,255,0.1)" }}
            >
              <button
                onClick={handleLogout}
                className="w-full flex items-center gap-2 px-3 py-2 text-xs text-white hover:bg-white/10 rounded transition-colors border-0 bg-transparent cursor-pointer"
              >
