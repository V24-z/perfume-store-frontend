...
const summaryVariants = {
  ...
  visible: { opacity: 1, y: 0, scale: 1, transition: { duration: 0.5, delay: 0.15, ease: [0.22, 1, 0.36, 1] } },
};
            ...
            >
              ...
              <motion.div initial="hidden" animate="visible" variants={staggerFields} className="space-y-5">
                <motion.div variants={fieldVariant}>
                  <label htmlFor="full_name" className="mb-1.5 block text-sm font-medium text-[#374151]">
                    Full name
                  </label>
                  <input
                    id="full_name"
